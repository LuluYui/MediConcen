      ...
      <Background>
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.textview}>
            ...
            />
    <View>
        <Button style={styles.button} onPress={this.showDatepicker} title="Show date picker!" />
        <Button style={styles.button} onPress={this.showTimepicker} title="Show time picker!" />
      </View>
             <DateTimePicker
